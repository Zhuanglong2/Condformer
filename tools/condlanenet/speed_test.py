...
def parse_args():
    ...
    parser.add_argument('--config', default=r"E:\lane-detecion\PycharmProjects\conditional-lane-detection-master\configs\condlanenet\tusimple\tusimple_medium_test.py", help='test config file path')
    parser.add_argument('--checkpoint',
                    default=r'E:\lane-detecion\PycharmProjects\conditional-lane-detection-master\tools\work_dirs\tusimple\medium\epoch_20.pth', help='test config file path')
